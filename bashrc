...
if [ "$USER" = 'root' ]; then
    if [ "$TERM" = "linux" ]; then
	if [[ $termdir = 1 ]]; then
	    PS1='\[\033[0;34;1m\]\u\[\033[m\]@\[\033[31m\]\h\[\033[0m\].\[\033[36m\]\l\[\033[0m\]:$(_____bran__bashrc_) \[\033[35m\]\w$(____clock__bashrc_)\[\033[0;31m\]\$\[\033[0m\] '
	else
	    PS1='\[\033[0;34;1m\]\u\[\033[m\]@\[\033[31m\]\h\[\033[0m\].\[\033[36m\]\l\[\033[0m\]:$(_____bran__bashrc_) \[\033[35m\]...$(____clock__bashrc_)\[\033[0;31m\]\$\[\033[0m\] '
	fi
    else
	if [[ $termdir = 1 ]]; then
	    PS1='\[\033[0;34m\]\u\[\033[m\]@\[\033[31m\]\h\[\033[0m\]:$(_____bran__bashrc_) \[\033[35m\]\w$(____clock__bashrc_)\[\033[0;31m\]\$\[\033[0m\] '
	else
	    PS1='\[\033[0;34m\]\u\[\033[m\]@\[\033[31m\]\h\[\033[0m\]:$(_____bran__bashrc_) \[\033[35m\]...$(____clock__bashrc_)\[\033[0;31m\]\$\[\033[0m\] '
	fi
    fi
elif [ "$USER" = 'nobody' ]; then
    if [ "$TERM" = "linux" ]; then
	if [[ $termdir = 1 ]]; then
	    PS1='\[\033[0;34;1m\]\u\[\033[m\]@\[\033[32m\]\h\[\033[0m\].\[\033[36m\]\l\[\033[0m\]:$(_____bran__bashrc_) \[\033[35m\]\w$(____clock__bashrc_)\[\033[0;32m\]\$\[\033[0m\] '
	else
	    PS1='\[\033[0;34;1m\]\u\[\033[m\]@\[\033[32m\]\h\[\033[0m\].\[\033[36m\]\l\[\033[0m\]:$(_____bran__bashrc_) \[\033[35m\]...$(____clock__bashrc_)\[\033[0;32m\]\$\[\033[0m\] '
	fi
    else
	if [[ $termdir = 1 ]]; then
	    PS1='\[\033[0;34m\]\u\[\033[m\]@\[\033[32m\]\h\[\033[0m\]:$(_____bran__bashrc_) \[\033[35m\]\w$(____clock__bashrc_)\[\033[0;32m\]\$\[\033[0m\] '
	else
	    PS1='\[\033[0;34m\]\u\[\033[m\]@\[\033[32m\]\h\[\033[0m\]:$(_____bran__bashrc_) \[\033[35m\]...$(____clock__bashrc_)\[\033[0;32m\]\$\[\033[0m\] '
	fi
    fi
else
    if [ "$TERM" = "linux" ]; then
	if [[ $termdir = 1 ]]; then
	    PS1='\[\033[0;34;1m\]\u\[\033[m\]@\[\033[34m\]\h\[\033[0m\].\[\033[36m\]\l\[\033[0m\]:$(_____bran__bashrc_) \[\033[35m\]\w$(____clock__bashrc_)\[\033[34;1m\]\$\[\033[0m\] '
	else
	    PS1='\[\033[0;34;1m\]\u\[\033[m\]@\[\033[34m\]\h\[\033[0m\].\[\033[36m\]\l\[\033[0m\]:$(_____bran__bashrc_) \[\033[35m\]...$(____clock__bashrc_)\[\033[34;1m\]\$\[\033[0m\] '
	fi
    else
	if [[ $termdir = 1 ]]; then
	    PS1='\[\033[0;34m\]\u\[\033[m\]@\[\033[34m\]\h\[\033[0m\]:$(_____bran__bashrc_) \[\033[35m\]\w$(____clock__bashrc_)\[\033[34;1m\]\$\[\033[0m\] '
	else
	    PS1='\[\033[0;34m\]\u\[\033[m\]@\[\033[34m\]\h\[\033[0m\]:$(_____bran__bashrc_) \[\033[35m\]...$(____clock__bashrc_)\[\033[34;1m\]\$\[\033[0m\] '
	fi
    fi
fi
}
